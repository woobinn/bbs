	...
	<div class="container">
		<div class="row">
			...
			<table class="table table-striped" style="text align: center; border: 1px solid #dddddd">
				<thead>
					<tr>
						<th colspan="2" style="background-color: #eeeeee; text-align: center;"> Submit a Post	
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						<td><textarea class="form-control" placeholder="Write Post" name="bbsContent" maxlength="2048" style="height: 350px;"></textarea></td>
					</tr>
				</tbody>
				</table>	
				<input type="submit" class="btn btn-primary pull-right" value="Publish Post">
